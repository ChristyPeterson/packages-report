...
write_csv(pack.df2, here("data", "add-on-packages.csv"))


## make a frequency table of package by the version in Built
pack_freqtable <- pack.df2 %>%
  count(Built) %>%
...
write_csv(pack_freqtable, here("data", "add-on-packages-freqtable.csv"))
